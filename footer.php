	...
	<div class="container">
		...
		<div class="row-fluid">
			<div class="span3 trending">
				...
				<ul>
					<li><a href="http://makercamp.com/wp-content/uploads/2014/07/Maker-Camp-License-Release-and-Waiver-2014.pdf" target="_blank">Hangout Participant Release Form</a></li>
			...
			<div class="span3 subscribe hidden-phone">
				<div class="sprite sprite-arrow-footer visible-desktop"></div>
