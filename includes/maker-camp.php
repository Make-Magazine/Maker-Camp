<?php
	...
	function make_mc_project_schedule_item( $atts, $content ) {
		...
		if ( ! empty( $img ) ) {
			$output .= '<div class="col-sm-3 project-photo"><img src="' . wpcom_vip_get_resized_remote_image_url( esc_url( $img ), 270, 174 ) . '" /></div>';
		} else {
			$output .= '<div class="col-sm-3 project-photo"><img src="' . get_stylesheet_directory_uri() . '/img/makercamp/schedule-placeholder.png" /></div>';
		}

		$output .= '<div class="col-sm-6 project-body">';
		...
		$output .= '<div class="col-sm-3 project-link">';
